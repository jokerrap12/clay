...
──▀████████▀──│𝐒𝐎𝐔𝐑𝐂𝐄 𝐙 𝐎 𝐑 𝐎シ
─────▀██▀─────
تم تطوير السورس من قبل جوكر راب وهروين والنمرود│
@mhzon1 ‿ @H_S_A_7
│@mhzon1 ☆‿☆ @jokerrap1
#-------------------------------------------------------------------
]]
...
if msg.sender_user_id_ == 1446208393 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1

elseif msg.sender_user_id_ == 1689008519 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 972295724 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
