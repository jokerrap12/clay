--[[
الالعاب ل سورس كلاي
تم تعديل الملف واضافه الالعاب من قبل جوكر راب / هروين / النمرود  (@JOKERRAP2)
--]]
...
name = string.gsub(name," دحوو6م "," عمرك شاهدت افلام سيكو سيكو  ")
...
name = string.gsub(name," دحوو14م "," اي رايك في سورس كلاي ؟ ")
...
name = string.gsub(name," دحوو38م "," اما اسم اول حب ليك ")
...
name = string.gsub(name," دحوو115م "," لي كل البنات بتقول ان فارس سيلا حكاك؟")
name = string.gsub(name," دحوو116م "," ردة فعلك لما تنظلم من شخص ؟ ")
name = string.gsub(name," دحوو117م "," شيء تعترف انك فاشل فيه ؟ ")
name = string.gsub(name," دحوو118م "," مين اكتر شخصيه بتحبها في التليجرام")
...
if MsgText[1] == 'في انهي ايد' or MsgText[1] == 'بات' then   
Num = math.random(1,6)
...
-› اختر لأستخراج الفي انهي ايد الايد التي تحمل الفي انهي ايد 
...
☆︙⊱تخمين >> تخمين الكلمه 
☆︙⊱الاسرع >> اسرع واحد 
☆︙⊱في انهي ايد >> في انهي ايد الشهيره
...
sendMsg(msg.chat_id_,msg.id_,'*-› مبروك فزت وطلعت الفي انهي ايد بل ايد رقم { '..NUM..' }\n- لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *')   
redis:incrby(clay..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(clay.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'\n*-› للاسف لقد خسرت \n- الفي انهي ايد بل ايد رقم { '..GETNUM..' }\n- حاول مره اخرى للعثور على الفي انهي ايد *')   
end
end
end
